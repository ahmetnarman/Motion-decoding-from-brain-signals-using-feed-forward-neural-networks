...
% Tiffany's code for splitting training from testing
testRatio = 0.2;
testTrials = floor(testRatio*length(trial(:,1)));
testIdx = randsample(length(trial(:,1)),testTrials);
trainIdx = ~ismember(1:length(trial(:,1)),testIdx);
